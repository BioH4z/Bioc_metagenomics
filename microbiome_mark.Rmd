...
```{r test_data, echo=TRUE, message=F, warning=F, include=F}
...
file.remove(file.path(miseq_path, "MiSeqSOPData.zip"))
...
download.file(url = "https://zenodo.org/record/801828/files/rdp_train_set_16.fa.gz?download=1", destfile = "~/rdp_train_set_16.fa.gz")
